...
library Size {
  ...
  /** Get value */
  function get(bytes32 id) internal view returns (SizeEnum value) {
  ...
  function get(IStore _store, bytes32 id) internal view returns (SizeEnum value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((id));
  ...
  /** Set value */
  function set(bytes32 id, SizeEnum value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((id));
  ...
  function set(IStore _store, bytes32 id, SizeEnum value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((id));
