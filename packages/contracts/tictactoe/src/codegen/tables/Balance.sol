...
library Balance {
  ...
  function get(IStore _store, address owner) internal view returns (uint256 amount) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((owner))));
  ...
  function set(IStore _store, address owner, uint256 amount) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((owner))));
  ...
  function encode(uint256 amount) internal view returns (bytes memory) {
