...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("tictactoe"), bytes16("Identity")));
...
library Identity {
  ...
  function getCreatedAt(IStore _store, bytes32 key) internal view returns (uint256 createdAt) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function setCreatedAt(bytes32 key, uint256 createdAt) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 1, abi.encodePacked((createdAt)));
  }

  /** Set createdAt (using the specified store) */
  function setCreatedAt(IStore _store, bytes32 key, uint256 createdAt) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));

    _store.setField(_tableId, _keyTuple, 1, abi.encodePacked((createdAt)));
  }
  ...
  function get(IStore _store, bytes32 key) internal view returns (IdentityData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function set(bytes32 key, string memory name, uint256 createdAt) internal {
    bytes memory _data = encode(name, createdAt);
  ...
  function set(IStore _store, bytes32 key, string memory name, uint256 createdAt) internal {
    bytes memory _data = encode(name, createdAt);
  ...
  function set(bytes32 key, IdentityData memory _table) internal {
    set(key, _table.name, _table.createdAt);
  }

  /** Set the full data using the data struct (using the specified store) */
  function set(IStore _store, bytes32 key, IdentityData memory _table) internal {
    set(_store, key, _table.name, _table.createdAt);
  }
  ...
  function encode(string memory name, uint256 createdAt) internal view returns (bytes memory) {
    uint40[] memory _counters = new uint40[](1);
    _counters[0] = uint40(bytes(name).length);
    PackedCounter _encodedLengths = PackedCounterLib.pack(_counters);

    return abi.encodePacked(createdAt, _encodedLengths.unwrap(), bytes((name)));
  }
