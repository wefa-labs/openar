      ...
      <div className=" mt-6 mr-4 items-center mt-50 flex justify-around relative flex-wrap px-5">
        <div className="max-w-xl relative">
          ...
          <p className="font-bold text-left">
            Here, you can do all the cool stuff from viewing your user card,
            playable games, stats to atcually creating your game world in AR !
          </p>
        </div>
        <div className=" mt-6 w-80 h-60  rounded-xl">
          <div className="relative block group  ">
            ...
            <div
              className="transition border-2 border-white rounded-lg group-hover:-translate-x-2 group-hover:-translate-y-2"
              style={{
