      ...
      <group ref={group} {...props} dispose={null}>
        <group name="Scene">
          <group name="root">
            ...
            <skinnedMesh
              name="antennasTop"
              geometry={nodes.antennasTop.geometry}
              skeleton={nodes.antennasTop.skeleton}
            >
              <meshBasicMaterial
                map={shadowTexture}
                side={DoubleSide}
                color={[0.5, 1, 0.5 * glowRoly]}
                toneMapped={false}
              />
            </skinnedMesh>
            <skinnedMesh
            ...
            <skinnedMesh
              ...
              skeleton={nodes.shield.skeleton}
            >
              <meshBasicMaterial
                map={shadowTexture}
                side={DoubleSide}
