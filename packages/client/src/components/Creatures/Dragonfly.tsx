...
useTexture.preload("assets/3D/DragonflyTextureRGB.jpg");
...
export default function DragonflyTicTacToe(props: any) {
  ...
  const { scene, animations } = useGLTF(
    "assets/3D/DragonflyTicTacToe-transformed.glb"
  ) as any;
   ...
   * Texture Loading
   */
  const shadowTexture = useTexture("assets/3D/DragonflyTextureRGB.jpg");
  ...
  useEffect(() => {
    ...
    action
      ?.reset() // Tweak Transition between Animations (can be done in Blender also)
      .fadeIn(0.1) // -> starting smooth
      .play(); // -> play

    return () =>
      // return will be called on dispose or rerender (in useEffect)
      {
      ...
      <group ref={group} {...props} dispose={null}>
        <group name="Scene">
          <group name="root">
            ...
            <skinnedMesh
              name="antenasTop"
              geometry={nodes.antenasTop.geometry}
              skeleton={nodes.antenasTop.skeleton}
            >
              <meshBasicMaterial
                map={shadowTexture}
                side={DoubleSide}
            ...
            <skinnedMesh
              name="feetsHips"
              geometry={nodes.feetsHips.geometry}
              skeleton={nodes.feetsHips.skeleton}
            >
              <meshBasicMaterial
                map={shadowTexture}
                side={DoubleSide}
            ...
            <skinnedMesh
              name="wingsCovering"
              geometry={nodes.wingsCovering.geometry}
              skeleton={nodes.wingsCovering.skeleton}
            >
              <meshBasicMaterial
                map={shadowTexture}
                side={DoubleSide}
            ...
            <skinnedMesh
              name="wingsStructure"
              geometry={nodes.wingsStructure.geometry}
              skeleton={nodes.wingsStructure.skeleton}
            >
              <meshBasicMaterial
                map={shadowTexture}
                side={DoubleSide}
...
useGLTF.preload("assets/3D/DragonflyTicTacToe-transformed.glb");
