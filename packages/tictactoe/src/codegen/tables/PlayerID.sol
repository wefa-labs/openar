...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16("tictactoe"), bytes16("PlayerID")));
...
library PlayerID {
  ...
  /** Get value */
  function get(address user, bytes32 gameId) internal view returns (bytes32 value) {
  ...
  function get(IStore _store, address user, bytes32 gameId) internal view returns (bytes32 value) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint160((user))));
    _keyTuple[1] = bytes32((gameId));
  ...
  /** Set value */
  function set(address user, bytes32 gameId, bytes32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint160((user))));
    _keyTuple[1] = bytes32((gameId));
  ...
  function set(IStore _store, address user, bytes32 gameId, bytes32 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint160((user))));
    _keyTuple[1] = bytes32((gameId));
